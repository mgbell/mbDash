...
$user = "mattgbell"; // <---- Your username goes here
$key = "d0d0bef0b0a335bb69f1f5e39fb53974"; //<-- Your API key goes here
...
if (isset($last['@attr']['nowplaying'])) {
	...
	$output = "Current song on Spotify: " . $last['name'] . ' by ' . $last['artist']['#text'];
